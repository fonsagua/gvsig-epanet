...
public class FixtureNetworkFactory {
	...
	addJunction("2", 200.00, 8500.00, 50, 1, 50, 100, 1);
	addReservoir("1", -800.00, 8500.00, 100, 0, 100, -1);
	addPipe("1", "1", "2", 1000, 300, 0.1, 1, 0.01, 0.00138, 0.04);
    }

    public void getReservoirTankJuctionWithDemand() {
	addJunction("2", 207.01, 8428.87, 20, 1, 33.46, 53.46, 1);
	addReservoir("1", -1321.66, 8460.72, 100, 0, 100, -12.14);
	addTank("3", -557.32, 8704.88, 50, 5, 0, 10, 5, 5, 55, 11.14);
	addPipe("1", "2", "3", 200, 50, 0.1, 1, 0.51, 7.70, 0.03);
	addPipe("2", "1", "3", 1000, 90, 0.1, 12.14, 1.91, 45, 0.02);
    }
	...
	addFlowControlValve("1", "2", "3", 90, 2, 2, 0.31, 16.69, 0);
    }
